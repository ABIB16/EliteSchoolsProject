...
public class Anneescolairetessst implements Serializable {
    ...
    public Anneescolairetessst() {
    }

    public Anneescolairetessst(Integer idanne) {
        this.idanne = idanne;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Anneescolairetessst)) {
            return false;
        }
        Anneescolairetessst other = (Anneescolairetessst) object;
