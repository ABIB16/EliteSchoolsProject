...
public class Anneescolairefff implements Serializable {
    ...
    public Anneescolairefff() {
    }

    public Anneescolairefff(Integer idanne) {
        this.idanne = idanne;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Anneescolairefff)) {
            return false;
        }
        Anneescolairefff other = (Anneescolairefff) object;
